...
class KafKa {
  ...
  public function ping() {
    ...
    if ((count($List) - $errTCP) == 0){
      throw new Exception_Base("No can use KafKa");
    }
  }
  ...
  public function newProducer() {
    return new Producer($this->BrokerList, $this->getKafKaConf(), $this->getTopicConf(), $this->Topic);
  }
  ...
  public function newConsumer() {
    return new Consumer($this->BrokerList, $this->getKafKaConf(), $this->getTopicConf(), $this->Topic);
  }
